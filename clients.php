...
<div id="container">
	...
	<div class="quo">
        ...
        echo "<td width='70'>";
		echo "<a href='?c_id1=$c_row[0]'><img src='images/delete.png' height='20' width='20' /></a>&nbsp;<a href='updateclients.php?c_id2=$c_row[0]'><img src='images/update.png' height='20' width='20' /></a>";
		echo "</td>";
		echo "</tr>";
		}
		?>
